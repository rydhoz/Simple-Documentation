import {
    Accessibility, Atom, Braces, Calculator, Car, Code2, CreditCard, Database, FileCode, FileText, FlaskConical, Gauge, GitBranch, GitPullRequest, Globe, Hash, Image, Layers, LayoutDashboard, Lightbulb, Link2, Lock, Mail, Palette, Pen, Play, Server, Sheet, Shield, ShieldCheck, Smartphone, Terminal, Webhook, Wind,
} from "lucide-react";
